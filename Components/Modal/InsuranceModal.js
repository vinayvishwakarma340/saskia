                  ...
                  <div className="mt-6 p-6  text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <div className="grid grid-cols-2 gap-8">
                      ...
                      <Link
                        target={"_blank"}
                        href={
                          "https://www.payumoney.com/react/app/merchant/#/pay/merchant/623023267B3FB506CB61B35FC7B043B9?param=6679215"
                        }
                        className="max-w-sm p-2 sm:p-6 cursor-pointer bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100  "
                      >
                        <Image
                          ...
                          alt="debit"
                        />
                        <div className="text-base flex justify-center">Pay</div>
                      </Link>
                    </div>
                  </div>
                </div>
